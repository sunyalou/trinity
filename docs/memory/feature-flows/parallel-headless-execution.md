...
> **Status**: Implemented
> **Created**: 2025-12-22
> **Updated**: 2026-05-08 (#728: `_drain_bounded` wrapper caps `asyncio.run(_drain_reader_threads)` executor thread at 90 s; prevents CPU spin when `safe_close_pipes` deadlocks on Python buffered I/O lock)
> **Verified**: 2026-02-05
