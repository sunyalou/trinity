...
> **Status**: Implemented
> **Created**: 2025-12-22
> **Updated**: 2026-05-12 (#808: `_set_idle_priority()` (SCHED_IDLE/nice) + `_scan_deadline` per-iteration check prevent orphan-killer daemon thread from starving health probes on 1-CPU containers)
> **Verified**: 2026-02-05
