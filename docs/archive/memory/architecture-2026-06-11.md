...
> **ARCHIVED 2026-06-11** — superseded by the restructured `docs/memory/architecture.md` (same content, deduplicated into Cross-Cutting Subsystem blocks). Kept for reference only; do not update.
