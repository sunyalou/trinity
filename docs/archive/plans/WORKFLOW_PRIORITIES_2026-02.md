...
> **⚠️ ARCHIVED 2026-06-03 — historical snapshot, not current.**
> Superseded by the living editorial roadmap at `.claude/ROADMAP.md`
> (maintained by `/roadmap-plan`). Preserved as a point-in-time record of
> strategic direction; do not treat its priorities as current — much of it
> shipped (Unified Executions Dashboard, notifications, reliability work).
