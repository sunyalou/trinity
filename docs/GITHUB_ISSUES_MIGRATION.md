...
> **Status**: Migration complete. Roadmap is tracked via **GitHub Issues** — labels (priority/type/theme/complexity) + open/closed state + native sub-issues. Issues-only SDLC: GitHub Project #6 ("Trinity Roadmap") was **archived on 2026-06-03** (see the closing note at the bottom of this file and `docs/planning/PROJECT_BOARD_DEPRECATION_2026-05.md`). The old `docs/memory/roadmap.md` has been archived to `docs/memory/roadmap-archive.md`. See `.claude/DEVELOPMENT_WORKFLOW.md` for the current SDLC.
>
